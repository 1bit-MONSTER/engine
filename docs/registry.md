...
At the current pins (llama.cpp `8dd75eb`, llama.cpp-vulkan `a29be7f`, ZINC `29bc350`): 323 HF architectures mapped, vulkan 323, hrx 300, zinc 64, npu 1. Mapped means a backend's code accepts the architecture; the census below reports how many were checked.
